...
{'setting_id': 'update.username', 'setting_type': 'string', 'setting_default': 'monpaf'},
{'setting_id': 'update.location', 'setting_type': 'string', 'setting_default': 'plugin.video.redlight'},
{'setting_id': 'update.token', 'setting_type': 'string', 'setting_default': ''},
#==================== Watched Indicators
